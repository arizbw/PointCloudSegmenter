...
final class Renderer {
    ...
    var numGridPoints = 150
    // Particle's size in pixels
    private let particleSize: Float = 30
...
extension Renderer {
    ...
    func saveFile(fileName: String, pointCloud: [[Double]], raw: Bool, beforeGlobalThread: [() -> Void], afterGlobalThread: [() -> Void], errorCallback: (XError) -> Void) {
